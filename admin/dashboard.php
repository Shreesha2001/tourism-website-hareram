		...
		<div class="four-grids">
					<div class="col-md-3 four-grid">
						<div class="four-agileits">
							...
							<div class="four-text">
								<h3><a href="manage-users.php">User</h3>
...
$cnt=$query->rowCount();
					...
					<div class="col-md-3 four-grid">
						<div class="four-agileinfo">
							...
							<h3><a href="manage-bookings.php">Bookings</h3>
...
$cnt1=$query1->rowCount();
					...
					<div class="col-md-3 four-grid">
						<div class="four-w3ls">
							...
							<div class="four-text">
								<h3><a href="manage-enquires.php">Enquiries</h3>
...
$cnt2=$query2->rowCount();
					...
					<div class="col-md-3 four-grid">
						<div class="four-wthree">
							...
							<div class="four-text">
								<h3><a href="manage-packages.php">Total packages</h3>
		...
		<div class="four-grids">
					<div class="col-md-3 four-grid">
						<div class="four-w3ls">
							...
							<div class="four-text">
								<h3><a href="manageissues.php">Issues Raised</h3>
