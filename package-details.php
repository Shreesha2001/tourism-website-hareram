...
$msg="Booked Successfully 
   You will be notified by Organizer within 2-3 days";
}
else 
{
...
<form name="book" method="post">
		<div class="selectroom_top">
			...
			<div class="col-md-8 selectroom_right wow fadeInRight animated" data-wow-delay=".5s">
				...
				<input class="" id="" type="month" placeholder=""  name="fromdate" required="">
			</div>
						<div class="clearfix"></div>
				<div class="grand">
					<p>Grand Total</p>
					<h3><?php echo $result->PackagePrice ?>+100₹</h3>
				</div>
			</div>
		...
		<div class="selectroom_top">
			...
			<h5>Map
			<a href= <?php echo htmlentities($result->gmaps);?> > Link</a>
		</div>
		</form>
<?php }} ?>
